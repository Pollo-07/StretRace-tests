...
import {validateChallengeActionWithNotification, validateChallengeCreate, validateIdBody,} from "../../../StretRace/src/application/middlewares/validationMiddleware";

describe("validation challenge (integration)", () => {
  const app = express();
